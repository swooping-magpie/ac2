...
hidden if the `aho-corasick2_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `aho-corasick2_DEVELOPER_MODE` to the configure
